...
export const metadata: Metadata = {
  title: "Alpine Retreat | Luxury Swiss Alps Hotel",
  description: "Experience premium mountain luxury at Alpine Retreat in the Swiss Alps. World-class hospitality, fine dining, spa, and breathtaking Alpine views.",
  keywords: "Swiss Alps hotel, luxury resort, mountain accommodation, fine dining, wellness spa",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763925505070-zn838f9m.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763925505070-zn838f9m.jpg"
  },
  openGraph: {
    title: "Alpine Retreat | Luxury Swiss Alps Hotel",
    description: "Experience premium mountain luxury in the heart of the Swiss Alps with unparalleled hospitality and stunning views.",
    siteName: "Alpine Retreat",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763925505070-zn838f9m.jpg",
      alt: "Luxury Alpine Retreat Hotel"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Alpine Retreat | Luxury Swiss Alps Hotel",
    description: "Discover world-class hospitality nestled in the Swiss Alps.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763925505070-zn838f9m.jpg"]
  },
  robots: {
    index: true,
    follow: true
